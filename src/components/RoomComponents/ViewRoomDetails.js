...
class ViewRoomDetails extends Component {
  constructor() {
    super();
  ...
  deleteRoomDetails(id) {
    ...
    return this.props.onDeleteRoom(id)
  ...
  render() {
    ...
    if(this.props.roomdetails===undefined){
      return(
        <h1>Loading....</h1>
      )
    }

    var roomsList = this.props.roomdetails.map((roomdetail, i) => {
      ...
      return (
        ...
        <Grid container alignItems="flex-start" spacing={4}>
            ...
            <Carousel afterChange={onChange}>
                ...
                <CardActionArea>
                    ...
                    <Typography variant="body2" color="textSecondary" component="p">
                        ...
                        <b>Type:</b> {roomdetail.roomType}<br/> 
                        
                        <b>Id:</b> {roomdetail.roomId}<br/>
                      
                        <b>rate_per_day:</b> {roomdetail.rate_per_day}<br/>
          ...
          ><Button onClick={ this.deleteRoomDetails.bind(this,roomdetail.roomId) }>
            Delete
          </Button>
          </Button>
          <Link to={"/admin/updateroom/"+roomdetail.roomId}>
          <Button
            variant="contained"
            color="primary"
            size="large"
...
const mapDispatchToState = (dispatch) =>{
  return {
    onFetchRoomDetails : () => dispatch(actions.fetchRoomDetails()),
    onDeleteRoom : (id) => dispatch(actions.deleteRoomDetails(id))
  }
}

export default connect(mapStateToProps,mapDispatchToState)(withStyles(styles)(ViewRoomDetails));